// Code generated by fileb0x at "2022-11-02 23:32:32.825134471 +0000 GMT m=+1.059302514" from config file "b0x.yml" DO NOT EDIT.
// modification hash(792fe6267a479cca0bd4dd80af4df3f6.be89261af1c9c296ff68287d42ae713a)
...
func init() {
	...
	err = FS.Mkdir(CTX, "assets/generic/daemon/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}
	...
	err = FS.Mkdir(CTX, "assets/f5bigip/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/f5bigip/f5bigip/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/f5bigip/f5/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}
